...
To overcome the drawbacks of existing methods, this approach aims to focus on:
\begin{itemize}
    ...
    \item Accuracy: Tailoring the solution to the station and acquiring real-time sensor data about
...
The Pseudocode of the General Algorithm is given in \Ref{alg:createSubpolygons}
...
The transformations between the different objects are illustrated by figure \Ref{label}.
...
Knockout value to its corresponding cost function. The penalty approach is explained 
in Algorithm \Ref{EvaluationAlgorithm}.
Figure \Ref{Obstacle} illustrates a case of obstacles blocking one of the subpolygons of the station.
...
\begin{figure}[H]
    \begin{center}
        \includegraphics[width=4in]{images/Chap2/Obstacles_In_Station.png} % Replace with your figure
...
\begin{figure}[H]
    \begin{center}
        \includegraphics[width=4in]{images/Chap2/Add_waypoints.png} % Replace with your figure
