...
the distance is clearly seen in figure \Ref{dock}. In order to reach the station as quickly as possible, the 
...
\textbf{Definition}: A station is an area where the pickup or drop process takes place. 
It is a rectangular area of the warehouse (yellow rectangle on figure \Ref{dock}) that consists of a 
