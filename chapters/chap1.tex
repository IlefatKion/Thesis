...
For instance, Ant Colony Optimization (2006), Particle Swarm Optimization (1995), and Artificial Bee Colony Optimization 
(2007) are examples of such algorithms. 
...
Although Genetic Algorithms integration in robotic path planning mafamech fel intralogistics very limited
2 major drawbacks no tests in real environments and no rationalization of obstacles: big par rapport robot, 
irrealistic shapes ...
