...
by the algorithm while computing \cite{R24}. In an experiment to compare global motion planners, 
Heiden et al. use different metrics on which 
...
path smoothing, 
computing steer functions, and checking for collision possibilities \cite{R23}. 
In a real time context, it is important to synchronize different tasks, 
