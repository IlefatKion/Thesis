...
as illustrate figures \Ref{OptResult12} and \Ref{OptResult18}. %TODO: here les schemas bel distances
...
\Ref{OptResult13}. The target is set at position \(x = \), \(y = \), and \(\rho = ^\circ\).
